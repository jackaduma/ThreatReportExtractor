...
def svm_train(arg1, arg2=None, arg3=None):
    ...
    if param.kernel_type == PRECOMPUTED:
        for xi in prob.x_space:
            ...
            if xi[0].index != 0:
                raise ValueError('Wrong input.txt format: first column must be 0:sample_serial_number')
            if val <= 0 or val > prob.n:
                raise ValueError('Wrong input.txt format: sample_serial_number out of range')
